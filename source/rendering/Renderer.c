...
void Renderer_Init(World* world_, Player* player_, WorkQueue* queue, GameState* gamestate_) {
	...
	//for(int i = 0; i < 100; i++){
	//gamestate = GameState_SplashScreen; //KEEP DISABLED! ENABLEING CAUSES CRASH!!
//}
	C3D_Init(C3D_DEFAULT_CMDBUF_SIZE);

	renderTargets[0] = C3D_RenderTargetCreate(240, 400, GPU_RB_RGBA8, GPU_RB_DEPTH24);
	renderTargets[1] = C3D_RenderTargetCreate(240, 400, GPU_RB_RGBA8, GPU_RB_DEPTH24);
	...
	lowerScreen = C3D_RenderTargetCreate(240, 320, GPU_RB_RGBA8, GPU_RB_DEPTH24);
